...
fourth_block_st_content = "Rocket scientist that decided slignshotting new IT technologies into customer centric orbits is far more interesting than space technolgy.  Is one of the first followers of GIG.tech and has been working for two decades in large multinational organisations building some of the foundations of internet services in Europe."
fourth_block_sec_content = "Believes that the IT industry needs a fundamental new and different approach, selling based on complexity and creating dependencies on maintenance plans and professional services to deal with the created complexity is not the right way forward. Weynand is currently Head of Solution Design at GIG Technology."
