...
var ambassadors = {
    "0x0": {
        ...
        "nationality": "Pakistani / UK",
        "why": "Virtual currencies are the future and the foundation is enabling a new mechanism for IT currency payments that can / will be the defect standard and a means of utilising capacity from day 1. They are educating and developing the market at the same time.",
        "avatar": "processed_osman.jpg",
        "name": "Osman Asghar Khan"
    },
    "1x0": {
        ...
        "nationality": "Dutch",
        "why": "I strongly believe that new technologies can help people to make this world a better place. This requires neutral and equal access to internet infrastructure, all over the world. The Threefold Foundation enables just that.",
        "avatar": "processed_bart.jpg",
    ...
    "2x0": {
        ...
        "nationality": "Belgian",
        "why": "The combination of 'resource efficient ICT' with a 'new global currency' address two of humanity's biggest challenges. How to grow sustainably both 'economically' and 'data-wise' within the limits of Earth's resources? Nobody knows. TF ambassadors attempt to tackle these challenges and spread the news.",
        "avatar": "processed_roel.jpg",
