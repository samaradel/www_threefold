...
* Quality team with good experience but maintaining a goof set of values
* Existing technology that is well positioned for Edge networking and often outperforms existing technologies from major vendors.
...
The Foundation’s long term objectives are the folllowing:
...
ThreeFold Tokens will be available for sale directly through our app or you can buy them through the ERC20 token mechanism.
...
The Tokens will be tradable on multiple Exchanges (any exchange supporting ERC20 tokens)
